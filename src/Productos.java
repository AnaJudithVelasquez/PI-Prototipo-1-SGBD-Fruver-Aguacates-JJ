...
public class Productos extends JFrame {
    ...
    private JTextField CantidadFinal;
    ...
    void agregar() {
        ...
        try {
            ...
            String FINAL_QUANTITY_Kg = CantidadFinal.getText();
            ...
            ps.setString(4, QUANTITY_Kg);
            ps.setString(5, FINAL_QUANTITY_Kg);
            ps.setString(6, PURCHASE_VALUE);
            ps.setString(7, PRODUCT_PRICE);
            ps.setString(8, DESCRIPTION_PRODUCT_STATUS);
    ...
    void modificar() {
        ...
        try {
            ...
            ps.setString(3, STOCK);
            ps.setString(4, QUANTITY_Kg);
            ps.setString(5, PURCHASE_VALUE);
            ps.setString(6, PRODUCT_PRICE);
            ps.setString(7, DESCRIPTION_PRODUCT_STATUS);
            ps.setString(8, COD_PRODUCT);
    ...
    void mostrarDatos() {
        ...
        try {
            ...
            if (model.getColumnCount() == 0) {
                ...
                model.addColumn("Cantidad Final_KG");
    ...
    void mostrarDatosCompra() {
        conectar();
        String sqlPURCHASE = "select p.COD_PURCHASE, p.COD_USER, p.COD_SUPPLIER, p.DATE_PURCHASE, p.TOTAL_PURCHASE_VALUE, pd.COD_PURCHASE, pd.PURCHASED_PRODUCT, pd.UNIT_VALUE, pd.QUANTITY_Kg, pd.TOTAL_PRODUCT from PURCHASES p join PURCHASES_DETAILS pd on p.COD_PURCHASE = pd.COD_PURCHASE";
